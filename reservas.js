/* ============================================================
   ...
   (function () {
    ...
    /* ---------- Data mínima: reservas só a partir da abertura do parque ---------- */
    var DATA_ABERTURA_PARQUE = '2026-09-12';

    (function setMinDate() {
      dataInput.setAttribute('min', DATA_ABERTURA_PARQUE);
      ...
      anivNascInput.setAttribute('max', hojeStr);
    })();
    ...
    nextBtn1.addEventListener('click', function () {
      ...
      if (dataInput.value < DATA_ABERTURA_PARQUE) {
        msg1.textContent = 'As reservas só estão disponíveis a partir de 12 de setembro de 2026.';
        msg1.classList.add('lp-nl-error');
        return;
      }
      var dow = diaDaSemana(dataInput.value);
